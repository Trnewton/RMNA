...
def heuns_step(func, x_0, y_0, h, *args):
    '''
        Performs a Heuns integration step with the given function and positions.

        Parameters
        ----------
        func : callable
            The function on which the Heuns step method will be performed
        x_0 : float
            x position of step
        y_0 : float
            y position of step
...
class RMNA:
    ...
    def read_CSV(self, file_name, delimiter=','):
        '''
            Used to read connections directly from a csv file. Performs the same 
            function as read_Graph but from a csv.
        '''
